...
{
       0,   175,   175,   179,   180,   184,   185,   186,   187,   191,
     195,   196,   200,   201,   202,   203,   204,   205,   208,   209,
     210,   214,   215,   219,   220,   224,   228,   229,   233,   234,
     238,   239,   243,   244,   248,   249,   253,   254,   255,   256,
     260,   264,   265,   269,   270,   271,   275,   279,   280,   284,
     285,   289,   290,   291,   292,   293,   294,   295,   296,   297,
     301,   302,   306,   310,   311,   315,   319,   323,   327,   331,
...
#line 175 "parser.y" /* yacc.c:1646  */
    {(yyval.start) = new Start((yyvsp[0].proram)) ; /*root = $$;*/}
#line 1554 "parser.tab.c" /* yacc.c:1646  */
    break;

  case 3:
#line 179 "parser.y" /* yacc.c:1646  */
    { (yyvsp[-1].proram)->decls.push_back((yyvsp[0].decl)); (yyval.proram) = (yyvsp[-1].proram);}
#line 1560 "parser.tab.c" /* yacc.c:1646  */
    break;

  case 4:
#line 180 "parser.y" /* yacc.c:1646  */
    { (yyval.proram) = new Program(); (yyval.proram)->decls.push_back((yyvsp[0].decl));}
#line 1566 "parser.tab.c" /* yacc.c:1646  */
    break;

  case 5:
#line 184 "parser.y" /* yacc.c:1646  */
    { (yyval.decl) = new Decl((yyvsp[0].variable_decl));}
#line 1572 "parser.tab.c" /* yacc.c:1646  */
    break;

  case 6:
#line 185 "parser.y" /* yacc.c:1646  */
    { (yyval.decl) = new Decl((yyvsp[0].function_decl));}
#line 1578 "parser.tab.c" /* yacc.c:1646  */
    break;

  case 7:
#line 186 "parser.y" /* yacc.c:1646  */
    { (yyval.decl) = new Decl((yyvsp[0].class_decl));}
#line 1584 "parser.tab.c" /* yacc.c:1646  */
    break;

  case 8:
#line 187 "parser.y" /* yacc.c:1646  */
    { (yyval.decl) = new Decl((yyvsp[0].interface_decl));}
...
#line 196 "parser.y" /* yacc.c:1646  */
    {/* todo: this rule looks wrong, it isn't even in project doc */}
